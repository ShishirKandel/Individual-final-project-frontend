...
class ShownBookScreen extends StatefulWidget {
   const ShownBookScreen({Key? key}) : super(key: key);

  @override
  State<ShownBookScreen> createState() => _ShownBookScreenState();
}

class _ShownBookScreenState extends State<ShownBookScreen> {
