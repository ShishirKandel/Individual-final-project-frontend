...
class SellerChat extends StatefulWidget {
  ...
  const SellerChat({Key? key}) : super(key: key);

  // const SellerChat({Key key, this.chatModel, this.sourchat}) : super(key: key);
  // final ChatModel chatModel;
...
class _SellerChatState extends State<SellerChat> {
  ...
  List<ConversationModel?> conversation = [
    ConversationModel(message: "Hey!", senderSelf: true, createdAt: "5 min ago"),
    ConversationModel(message: "Hello, what can i do for you!", senderSelf: false, createdAt: "3 min ago"),
    ConversationModel(message: "Yes, can we do this?", senderSelf: true, createdAt: "1 min ago"),
    ConversationModel(message: "We can do it if you like", senderSelf: false, createdAt: "1 min ago"),
